...
% for AI usage page
\usepackage{grffile,graphbox}
\usepackage{fancyhdr}
\usepackage[svgnames]{xcolor}


\usepackage[acronym,nomain,toc]{glossaries} % TODO: include "acronym" if glossary and acronym should be separated
\makeglossaries
...
\pgfplotscreateplotcyclelist{TUM-corporate}{
  {TUMBlue!50!black,fill=TUMBlue},
  {TUMAccentOrange!50!black,fill=TUMAccentOrange},
  {TUMAccentGreen!50!black,fill=TUMAccentGreen},
  {TUMAccentLightBlue!50!black,fill=TUMAccentLightBlue},
  {TUMLightGray!50!black,fill=TUMLightGray},
  {TUMSecondaryBlue!50!black,fill=TUMSecondaryBlue},
  {TUMGray!50!black,fill=TUMGray},
  {TUMSecondaryBlue2!50!black,fill=TUMSecondaryBlue2},
}
...
\lstset{
  ...
  autogobble,
  deletekeywords=[2]{id,type,filter},
