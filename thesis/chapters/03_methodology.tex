...
In the scope of this thesis, we aim to compare multiple different Document Parsing and Chunking techniques with each other. As of the time of writing, every DP implementation defines their own datatypes, making comparisons very complex. For the purpose of this thesis, we define our own universal datatypes.
