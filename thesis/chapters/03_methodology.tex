...
The ChunkingResult (\autoref{fig:chunks}) is the output of the chunking module. It provides a wrapper around a list of Chunks, adding a \lstinline!metadata! field for information about the document and the preceding processes.
...
\begin{figure}[htpb]
  ...
  \caption[ChunkingResult]{Python implementation of the ChunkingResult and Chunk data types.}\label{fig:chunks}
\end{figure}
