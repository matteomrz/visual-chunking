...
The efficiency of such a \gls{rag} system is fundamentally constrained by the quality and relevance of the context retrieved from the knowledge base \autocite{dense_x,data_quality_rag}. The quality of the construction of the knowledge base directly determines wether the correct context can be retrieved for a given query \autocite{rag_survey}. Therefore, the construction of the knowledge base out of the oncology guidelines is a critical aspect of the project. Additionally, as the project has a clear focus on verifiability and traceability, there is an additional requirement to provide visual source attribution. This means that retrieved passages need to include accurate positional information, giving visual confirmation to the practicioner about the origin of the retrieved context \autocite{visa}.
